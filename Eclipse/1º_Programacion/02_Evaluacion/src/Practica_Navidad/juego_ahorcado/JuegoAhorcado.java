package Practica_Navidad.juego_ahorcado;
...
public class JuegoAhorcado {
	...
	public static void main(String[] args) {
		System.out.println("Juego del ahorcado, desarrollado de A.David Temi�o\n\n\n");
		try {
			int opcion = -1;
